...
class Ui_adduserDialog(object):
    def setupUi(self, adduserDialog):
        ...
        self.groupcomboBox.setContextMenuPolicy(QtCore.Qt.DefaultContextMenu)
        self.groupcomboBox.setEditable(True)
        self.groupcomboBox.setInsertPolicy(QtWidgets.QComboBox.InsertAtBottom)
        self.groupcomboBox.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContentsOnFirstShow)
        self.groupcomboBox.setDuplicatesEnabled(False)
